...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //EasyAccept.main(new String[]{facade, "tests/us5_1.txt"}); // Preciso consertar
        //EasyAccept.main(new String[]{facade, "tests/us5_2.txt"}); // Preciso consertar
        ...
        EasyAccept.main(new String[]{facade, "tests/us8_2.txt"}); // Preciso consertar
    }
}
